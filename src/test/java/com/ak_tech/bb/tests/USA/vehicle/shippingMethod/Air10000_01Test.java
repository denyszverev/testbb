...
public class Air10000_01Test extends TestBase {
    ...
    public void testAir10000_01() {
        ...
        app.navigate().enterValue(new TempData().withValue(CalculatorUSA.valueUSD = "10000.01"));
