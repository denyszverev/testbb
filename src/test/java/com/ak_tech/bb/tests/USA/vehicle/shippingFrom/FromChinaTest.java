...
public class FromChinaTest extends TestBase {
    ...
    @Test()
    public void testFromChina() {
        app.navigate().whatImporting(VEHICLE);
        app.navigate().countyGoingTo(USA);
        app.navigate().chooseYear(Year.year1800_1993);
        app.navigate().chooseShippingFrom(ShippingFrom.China);
        app.navigate().chooseMadeProduct(ProductMade.China);
