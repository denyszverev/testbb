...
public class NewfoundlandAdnLabradorTest extends TestBase {
    ...
    @Test()
    public void testNewfoundlandAdnLabrador() {
        app.navigate().whatImporting(VEHICLE);
        app.navigate().countyGoingTo(CANADA);
        app.provincePage().chooseProvince(Province.NewfoundlandAndLabrador);
