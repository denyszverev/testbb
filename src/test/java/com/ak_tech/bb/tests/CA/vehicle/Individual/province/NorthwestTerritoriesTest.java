...
public class NorthwestTerritoriesTest extends TestBase {
    ...
    @Test()
    public void testNorthwestTerritories() {
        app.navigate().whatImporting(VEHICLE);
        app.navigate().countyGoingTo(CANADA);
        app.provincePage().chooseProvince(Province.NorthwestTerritories);
